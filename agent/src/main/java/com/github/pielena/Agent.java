...
public class Agent {
    ...
    private static byte[] changeMethod(byte[] originalClass) {
        ...
        //for this implementation it's useless to select annotated methods. Perhaps we need a class annotation and select annotated classes...
...
//        ClassWriter cw = new ClassWriter(cr, ClassWriter.COMPUTE_MAXS);
        ...
        if (!classNode.name.contains("pielena")) {
...
//        }
        ...
        return writeArgs(originalClass);
...
//                    System.out.println("We're here: " + name);
...
//        return cw.toByteArray();
    ...
    private static byte[] writeArgs(byte[] originalClass) {
...
//    }
    ...
    static class LogInjector extends MethodVisitor {
        ...
        public void visitVarInsn(int opcode, int var) {
            ...
            if (var >= firstUnusedVar) {
                firstUnusedVar = var + 1;
            }
        }

        @Override
        public AnnotationVisitor visitAnnotation(String descriptor, boolean visible) {
            if (descriptor.contains("Lcom/github/pielena/Log")) {
                hasAnnotation = true;
                System.out.println("Annotation descriptor: " + descriptor);
            }
...
//                        name = Type.getObjectType(owner).getClassName();
            ...
            if (arg.length == 0) {
                ...
                sb.append(", params: ");
                sb.append("%s, ".repeat(arg.length - 1));
                sb.append("%s %n");
            }
            return sb.toString();
        }
